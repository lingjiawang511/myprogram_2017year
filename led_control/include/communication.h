...
//================================================
#define		RS485EN_IO					GPIO_Pin_11
#define		RS485EN_PORT				GPIOA
#define   RS485EN_RCC				  RCC_APB2Periph_GPIOA


#define   RS485_SEND   	     GPIO_SetBits(GLED_PORT	, GLED_IO)
#define   RS485_REC  		     GPIO_ResetBits(GLED_PORT	, GLED_IO)
