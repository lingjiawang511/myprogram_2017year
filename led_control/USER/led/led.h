...
#define		RLED_IO					GPIO_Pin_12
#define		RLED_PORT				GPIOB
#define   RLED_RCC				RCC_APB2Periph_GPIOB


#define       GLED_OFF   	GPIO_SetBits(GLED_PORT	, GLED_IO)
#define       GLED_ON  		GPIO_ResetBits(GLED_PORT	, GLED_IO)
#define       RLED_ON   	GPIO_SetBits(RLED_PORT, RLED_IO)
#define       RLED_OFF 	 	GPIO_ResetBits(RLED_PORT,RLED_IO)
